<template>
  ...
  <el-dialog
    ...
    width="30%"
  >
    <el-form :model="roleInfo" :rules="add">
      <el-form-item label="角色名："><el-input placeholder="请输入角色名" v-model="roleInfo.roleName"></el-input></el-form-item>
    </el-form>
    <template #footer>
...
import { reqRoleList, reqRemoveRole } from "@/api/acl/role/index";
